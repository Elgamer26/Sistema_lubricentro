...
<section class="content-header">
    <h1>
        <b> Listado de reservas <i class="fa fa-list"></i> <i class="fa fa-calendar"></i> </b>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="col-md-13">
        <div class="box box-success box-solid">
            <div class="box-header with-border center" style="text-align: center;">
                <h3 class="box-title"><i class="fa fa-list-alt"></i> Listado de reservas </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <table id="tbala_reservass" class="display responsive nowrap" style="width:100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Acci&oacute;n</th>
...
<script>
    listar_reservass_clientes_usuario();
</script>