...
<section class="content-header">
    <h1>
        <b> Registrar empleado <i class="fa fa-user-plus"></i> </b>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="col-md-13">
        <div class="box box-success box-solid">
            <div class="box-header with-border center" style="text-align: center;">
                <h3 class="box-title"><i class="fa fa-user-plus"></i> Registrar empleado</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <label for="titulo_">Titulo Senescyt</label> &nbsp;&nbsp; <label style="color:red;" id="totulo_obligg"></label>
                        <input type="text" class="form-control" id="titulo_" maxlength="50" placeholder="Ingrese titulo de Senescyt"><br>
                    </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="date" value="<?php echo $fecha ?>" class="form-control" id="fecha_ingreso"><br>
                    </div>
                    ...
                    <div class="col-lg-12" style="text-align: center">
                        <button type="button" class="btn btn-danger" onclick="cargar_contenido('contenido_principal','vista/empleado/nuevo_empleado.php')"><i class="fa fa-trash-o"></i> Limpiar</button> -
                        <button type="button" class="btn btn-success" onclick="registrar_empleado()"><i class="fa fa-save"></i> Registrar</button>
                    </div>
