...
<section class="content-header">
    <h1>
        <b> Reporte de compras <i class="fa fa-shopping-cart"></i> </b>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="col-md-13">
        <div class="box box-success box-solid">
            <div class="box-header with-border center" style="text-align: center;">
                <h3 class="box-title"><i class="fa fa-file"></i> Reporte de compras</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        <label>Buscar</label>
                        <button class="btn btn-danger" onclick="ver_reporte_compra();"> <i class="fa fa-eye"></i> Ver</button>
                    </div>

                    <div class="col-lg-12">
                        <center>
                            <iframe width="100%" height="100%" class="contennidor" id="iframe_compra"></iframe>
                        </center>
                    </div>
...
<script>
    ...
    function ver_reporte_compra() {
        ...
        var ifrm = document.getElementById("iframe_compra");
        ifrm.setAttribute("src", "../ADMIN/REPORTES/Pdf/Reportes/reporte_compra.php?f_i='" + fecha_inicio + "'&f_f='" + fecha_fin + "'");
