...
<section class="content-header">
    <h1>
        <b> Registrar cliente <i class="fa fa-user-plus"></i> </b>
    </h1>
    <ol class="breadcrumb">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-lg-12" style="text-align: center">
                        <button type="button" class="btn btn-danger" onclick="cargar_contenido('contenido_principal','vista/servicio/registro_cliente.php')"><i class="fa fa-trash-o"></i> Limpiar</button> -
                        <button type="button" class="btn btn-success" onclick="registrar_cliente()"><i class="fa fa-save"></i> Registrar</button>
                    </div>
