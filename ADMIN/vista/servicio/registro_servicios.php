...
<section class="content-header">
    <h1>
        <b> Registro de servicio <i class="fa fa-wrench"></i> </b>
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="col-md-13">
        <div class="box box-success box-solid">
            <div class="box-header with-border center" style="text-align: center;">
                <h3 class="box-title"><i class="fa fa-wrench"></i> <b>Registro de servicio</b> </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <label for="cliente_id">Cliente</label> &nbsp;&nbsp; <label style="color:red;" id="clienet_obligg"></label>
                        <select class="cliente_id form-control" id="cliente_id"></select><br>
                    </div>

                    <div class="col-lg-6">
                        <label for="vehculos_id">Vehiculos</label> &nbsp;&nbsp; <label style="color:red;" id="vehculo_obligg"></label>
                        <select class="vehculos_id form-control" id="vehculos_id"></select><br>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab_3" data-toggle="tab"><b><i class="fa fa-wrench"></i> Servicios </b> &nbsp;&nbsp; <label style="color:red;" id="agudeza_lis_obligg"></label></a></li>
                                <li><a href="#tab_4" data-toggle="tab"><b><i class="fa fa-cubes"></i> Productos </b> &nbsp;&nbsp; <label style="color:red;" id="tipo_lis_obligg"></label></a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <label>Servicios</label> &nbsp;&nbsp; <label style="color:red;" id="servicio_obigg"></label>
                                            <select id="servicios" style="width: 100%;" class="servicios_select form-control"></select><br>
                                        </div>

                                        <div class="forever_oler_asa">

                                            <div class="col-lg-2">
                                                <label for="precio_ser">Precio</label>
                                                <input disabled type="number" id="precio_ser" class="form-control">
                                            </div>

                                            <div class="col-lg-2">
                                                <label for="cantidad_ser">Cantidad servicio</label> &nbsp;&nbsp; <label style="color:red;" id="cantidad_ser_obigg"></label>
                                                <input type="text" disabled maxlength="5" onkeypress="return soloNumeros(event);" min="1" value="1" id="cantidad_ser" class="form-control">
                                            </div>

                                            <div class="col-lg-2">
                                                <label for="descuento_ser">Descuento $</label>
                                                <input type="number" onkeypress="return filterfloat(event, this);" min="0" value="0" id="descuento_ser" class="form-control">
                                            </div>

                                            <div class="col-lg-1">
                                                <label for="">&nbsp;</label>
                                                <button onclick="agg_servicios();" class="btn btn-primary" title="agregar el tratamiento"><i class="fa fa-plus"></i> Agregar</button>
                                            </div>
                                        ...
                                        <!-- tabla para insertar los medicamento a la tabla -->
                                        <div class="table-responsive col-lg-12"><br>

                                            <table id="tabla_servicios" style="width: 100%;" class="table">
                                            ...
                                            <div class="col-lg-12" style="text-align: right;">
                                                <label for="" id="lbl_sub_servicio"></label>
                                                <input hidden type="text" id="txt_sub_servicio">
                                            </div>
                                ...
                                <div class="tab-pane" id="tab_4">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12" style="text-align: right;">
                                            ...
                                            <input hidden value="0" type="text" id="txt_totalneto">
                                        </div>


                                        <div class="col-lg-12" style="text-align: right;">
                                            <label for="" id="lbl_impuesto"></label>
                                            <input hidden value="0" type="text" id="txt_impuesto">
                                        </div>

                                        <div class="col-lg-12" style="text-align: right;">
                                            <label for="" id="lbl_a_pagar"></label>
                                            <input hidden value="0" type="text" id="txt_a_pagar">
                                        </div>
                    ...
                    <div class="col-lg-12" style="text-align: center">
                        <button type="button" class="btn btn-danger" onclick="cargar_contenido('contenido_principal','vista/servicio/registro_servicios.php');"><i class="fa fa-trash-o"></i> Limpiar</button> -
                        <button type="button" class="btn btn-success" onclick="registar_servicio_cliente();"><i class="fa fa-save"></i> Ingresar</button>
                    </div>
...
<script>
    ...
    $("#cliente_id").change(function() {
        ...
        traer_datos_vehiculos_clientes(parseInt(id));
    });

    $("#servicios").change(function() {
        var id = $("#servicios").val();
        traer_precio_servicios(parseInt(id));
    });

    ///////////////////////
    function listar_clientes_vehoculos() {
        funcion = "listar_clientes_vehoculos";
        $.ajax({
            ...
            if (data.length > 0) {
                ...
                for (var i = 0; i < data.length; i++) {
                    cadena +=
                        "<option value='" + data[i][0] + "'> " + data[i][1] + " " + data[i][2] + " - " + data[i][3] + " - " + data[i][4] + "</option>";
                }
                //aqui concadenamos al id del select
                $("#cliente_id").html(cadena);
                var id = $("#cliente_id").val();
                traer_datos_vehiculos_clientes(parseInt(id));
            } else {
    ...
    function traer_datos_vehiculos_clientes(id) {
        funcion = "traer_datos_vehiculos_clientes";
        $.ajax({
            url: "../ADMIN/controlador/servicio/servicio.php",
            type: "POST",
            data: {
    ...
    function traer_precio_servicios(id) {
        funcion = "traer_precio_servicios";
        $.ajax({
            url: "../ADMIN/controlador/servicio/servicio.php",
            type: "POST",
            data: {
    ...
    ///////////////////////
    function agg_servicios() {

        var id = $("#servicios").val();
        var servicio = $("#servicios option:selected").text();
        var precio = $("#precio_ser").val();
        var cantidad = $("#cantidad_ser").val();
        var descuento = $("#descuento_ser").val();
        var subtotal = 0;

        if (id.length == 0) {
            $("#servicio_obigg").html("No hay servicio");
            return Swal.fire(
        ...
        if (cantidad.length == 0 || cantidad == 0 || cantidad == "0") {
            return Swal.fire(
                "Mensaje de advertencia",
                "Debe ingresar cantidad de servicio",
                "warning"
            );
        }
        ...
        if (descuento.length == 0) {
            return Swal.fire(
                "Mensaje de advertencia",
                "INgrese el valor de descuento o dejelo en cero (0)",
                "warning"
            );
        }

        if (verificar_servicio_(id)) {
            return Swal.fire(
                "Mensaje de advertencia",
                "El servicio '" + servicio + "', ya fue agregado al detalle",
                "warning"
            );
        }

        var desde = parseFloat(precio * descuento / 100).toFixed(2);
        subtotal = parseFloat((cantidad * precio - desde)).toFixed(2);
        ...
        datos_agg += "<td>" + desde + "</td>";
        datos_agg += "<td>" + subtotal + "</td>";
        datos_agg +=
            "<td><button onclick='remove_servicio(this)' class='btn btn-danger'><i class='fa fa-trash'></i></button></td>";
        datos_agg += "</tr>";

        //esto me ayuda a enviar los datos a la tabla
        $("#tbody_servicios").append(datos_agg);
    ...
    function verificar_servicio_(id) {
        let idverificar = document.querySelectorAll(
            "#tbody_servicios td[for='id']"
        );
        return (
    ...
    function sumar_servicio() {
        ...
        $("#lbl_sub_servicio").html("<b>Total: $.</b> " + total);
        $("#txt_sub_servicio").val(total);
        ...
        if ($("#tipo_pro").val() != "") {
            if (tipo_pro == "2 x 1") {
                ...
                if ($("#cantidad").val() % 2 == 0) {
                    ...
                    total = parseFloat(subtotal - des_promo - desde).toFixed(2);
                }
            }
        }
